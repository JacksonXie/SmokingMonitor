...
class UserInformationViewController:UIViewController,UITextFieldDelegate,UIPickerViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        targetNumberLabel.font = UIFont(name:"Helvetica",size:14)
        targetNumberLabel.text = "Target Smoking Number per Day"
        targetNumberLabel.sizeToFit()
        //Target number pick
        
        TargetNumberPick.frame = CGRectMake(100, 140, 130, 162)
        ...
        //SmokeAge pic
        SmokeAgePic.frame = CGRectMake(100, 140, 130, 162)
